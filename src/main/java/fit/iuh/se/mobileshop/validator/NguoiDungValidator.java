...
public class NguoiDungValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		// check địa chỉ email phù hợp hay không - chỉ kiểm tra nếu email không null
		...
		// check độ dài password (8-32) - chỉ kiểm tra nếu password không null
		...
		// check match pass và confirmPass - chỉ kiểm tra nếu cả hai không null
