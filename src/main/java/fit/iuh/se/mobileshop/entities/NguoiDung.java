...
public class NguoiDung {
	...
	// WRITE_ONLY: Cho phép nhận password từ request nhưng không trả về trong response
	@JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
	private String password;
	
	@Transient
	// WRITE_ONLY: Cho phép nhận confirmPassword từ request nhưng không trả về trong response
	@JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
	...
	@com.fasterxml.jackson.annotation.JsonIgnoreProperties(value = {"nguoiDung", "hibernateLazyInitializer", "handler"})
