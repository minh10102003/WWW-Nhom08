...
-- Dumping data for table iphone_shop.chi_muc_gio_hang: ~5 rows (approximately)
...
-- Dumping data for table iphone_shop.chi_tiet_don_hang: ~82 rows (approximately)
INSERT INTO `chi_tiet_don_hang` (`id`, `don_gia`, `so_luong`, `ma_don_hang`, `ma_san_pham`, `so_luong_dat`, `so_luong_nhan_hang`) VALUES
	...
	(34, 19690000, NULL, 69, 24, 1, 1),
	(35, 16990000, NULL, 69, 22, 1, 1),
	(36, 21990000, NULL, 70, 15, 1, 0),
	(37, 27990000, NULL, 71, 17, 1, 0),
	(38, 22990000, NULL, 71, 20, 1, 0),
	(39, 23990000, NULL, 71, 16, 1, 0),
	(40, 30990000, NULL, 72, 14, 1, 0),
	(41, 16990000, NULL, 73, 18, 1, 0),
	(42, 16990000, NULL, 74, 18, 1, 0),
	(43, 30990000, NULL, 75, 14, 1, 1),
	(44, 21990000, NULL, 76, 15, 1, 1),
	(45, 26990000, NULL, 77, 13, 1, 0),
	(46, 26990000, NULL, 78, 13, 1, 0),
	(47, 16990000, NULL, 79, 22, 1, 0),
	(48, 44490000, NULL, 79, 23, 1, 0),
	(49, 26990000, NULL, 80, 13, 1, 0),
	(50, 16990000, NULL, 81, 22, 1, 0),
	(51, 26990000, NULL, 82, 13, 1, 0),
	(52, 26990000, NULL, 83, 13, 1, 0),
	(53, 16990000, NULL, 84, 22, 1, 0),
	(54, 44490000, NULL, 85, 23, 1, 0),
	(55, 16990000, NULL, 85, 22, 1, 0),
	(56, 44490000, NULL, 86, 23, 1, 0),
	(57, 27990000, NULL, 87, 17, 1, 0),
	(58, 16990000, NULL, 87, 18, 1, 0),
	(59, 44490000, NULL, 88, 23, 1, 0),
	(60, 16990000, NULL, 89, 18, 1, 0),
	(61, 44490000, NULL, 89, 23, 1, 0),
	(62, 30990000, NULL, 89, 14, 1, 0),
	(63, 30990000, NULL, 90, 14, 1, 0),
	(64, 26990000, NULL, 91, 13, 1, 0),
	(65, 44490000, NULL, 92, 23, 1, 0),
	(66, 16990000, NULL, 92, 22, 1, 0),
	(67, 44490000, NULL, 93, 23, 1, 0),
	(68, 16990000, NULL, 93, 18, 1, 0),
	(69, 21990000, NULL, 93, 15, 1, 0),
	(70, 27990000, NULL, 94, 17, 1, 0),
	(71, 18990000, NULL, 95, 19, 1, 0),
	(72, 27990000, NULL, 96, 17, 1, 0),
	(73, 16990000, NULL, 97, 18, 1, 0),
	(74, 27990000, NULL, 98, 17, 1, 0),
	(75, 16990000, NULL, 99, 22, 1, 0),
	(76, 24990000, NULL, 100, 12, 1, 0),
	(77, 27990000, NULL, 101, 17, 1, 0),
	(78, 44490000, NULL, 102, 23, 1, 0),
	(79, 16990000, NULL, 102, 18, 1, 0),
	(80, 30990000, NULL, 102, 14, 1, 0),
	(81, 22990000, NULL, 103, 20, 1, 0),
	(82, 24990000, NULL, 104, 12, 1, 0),
	(83, 22990000, NULL, 105, 20, 1, 0),
	(84, 21990000, NULL, 106, 15, 1, 0),
	(85, 27990000, NULL, 107, 17, 1, 1),
	(86, 18990000, NULL, 107, 19, 1, 1);
...
-- Dumping structure for table iphone_shop.cuoc_tro_chuyen
CREATE TABLE IF NOT EXISTS `cuoc_tro_chuyen` (
  ...
  `thoi_gian_tin_nhan_cuoi` datetime(6) DEFAULT NULL,
  `tin_nhan_cuoi_cung` varchar(255) DEFAULT NULL,
  `trang_thai` varchar(255) DEFAULT NULL,
  `admin_id` bigint(20) DEFAULT NULL,
  `khach_hang_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKlla540yermg8xyhbk0kd77u0i` (`admin_id`),
  KEY `FKd7fc55hckv61f8tmmnrcg7pp6` (`khach_hang_id`),
  CONSTRAINT `FKd7fc55hckv61f8tmmnrcg7pp6` FOREIGN KEY (`khach_hang_id`) REFERENCES `nguoi_dung` (`id`),
  CONSTRAINT `FKlla540yermg8xyhbk0kd77u0i` FOREIGN KEY (`admin_id`) REFERENCES `nguoi_dung` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;

-- Dumping data for table iphone_shop.cuoc_tro_chuyen: ~2 rows (approximately)
INSERT INTO `cuoc_tro_chuyen` (`id`, `thoi_gian_cap_nhat`, `thoi_gian_tao`, `thoi_gian_tin_nhan_cuoi`, `tin_nhan_cuoi_cung`, `trang_thai`, `admin_id`, `khach_hang_id`) VALUES
	(3, '2025-12-09 19:45:58.166000', '2025-12-09 19:14:40.981000', '2025-12-09 19:45:58.166000', '2', 'dang_chat', 55, 59),
	(4, '2025-12-09 19:45:00.611000', '2025-12-09 19:41:57.514000', '2025-12-09 19:45:00.611000', '3', 'dang_chat', 55, 60);
...
-- Dumping data for table iphone_shop.don_hang: ~78 rows (approximately)
INSERT INTO `don_hang` (`id`, `dia_chi_nhan`, `ghi_chu`, `ho_ten_nguoi_nhan`, `ngay_dat_hang`, `ngay_giao_hang`, `ngay_nhan_hang`, `sdt_nhan_hang`, `trang_thai_don_hang`, `ma_nguoi_dat`, `ma_shipper`, `tong_gia_tri`, `da_thanh_toan`, `phuong_thuc_thanh_toan`) VALUES
	...
	(69, 'sdf', 'sadf', 'Phạm Anh Khoa', '2025-12-08 23:56:36', '2025-12-08 23:58:44', '2025-12-09 11:44:39', '0901234567', 'Chờ duyệt', 59, 3, 36680000, b'1', 'online'),
	(70, 'sdf', 'sdf', 'Nguyễn Văn A', '2025-12-08 23:58:10', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 21990000, b'0', 'cod'),
	(71, 'sd', 'sd', 'Nguyễn Văn A', '2025-12-09 10:40:23', NULL, NULL, 'sdf', 'Đang chờ giao', 59, NULL, 74970000, b'0', 'cod'),
	(72, 'asdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 10:46:41', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 30990000, b'0', 'cod'),
	(73, 'sdfsdf', 'sdfsdf', 'Nguyễn Văn A', '2025-12-09 11:39:31', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 16990000, b'0', 'cod'),
	(74, 'sdfsdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 11:40:18', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 16990000, b'0', 'cod'),
	(75, 'sfdfgdfgdf', 'dfgdfgdfgf', 'Nguyễn Văn A', '2025-12-09 11:40:41', '2025-12-09 11:44:01', '2025-12-09 17:14:51', '0901234567', 'Chờ duyệt', 59, 3, 30990000, b'1', 'online'),
	(76, 'sdfsdf', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 11:42:42', '2025-12-09 11:43:57', '2025-12-09 17:14:48', '0901234567', 'Chờ duyệt', 59, 3, 21990000, b'1', 'online'),
	(77, 'sdfdsf', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 12:14:44', NULL, NULL, '0901234567', 'Đang chờ giao', 3, NULL, 26990000, b'0', 'cod'),
	(78, 'wer', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 12:15:51', NULL, NULL, '0901234567', 'Chờ thanh toán', 59, NULL, 26990000, b'0', 'online'),
	(79, '', '', '', '2025-12-09 12:16:06', NULL, NULL, '', 'Đang chờ giao', 59, NULL, 61480000, b'0', 'cod'),
	(80, 'sdfsd', 'sdfsd', 'Phạm Anh Khoa', '2025-12-09 12:16:44', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 26990000, b'0', 'cod'),
	(81, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 12:17:38', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 16990000, b'1', 'online'),
	(82, 'sdfsdf', 'sdfsdsdfsd', 'Phạm Anh Khoa', '2025-12-09 12:22:27', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 26990000, b'1', 'online'),
	(83, 'sdf', 'sdfsd', 'Phạm Anh Khoa', '2025-12-09 12:27:01', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 26990000, b'1', 'online'),
	(84, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 12:27:47', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 16990000, b'0', 'cod'),
	(85, 'sdfds', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 12:28:03', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 61480000, b'0', 'cod'),
	(86, 'sdfsdf', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 12:28:43', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 44490000, b'1', 'online'),
	(87, 'sdf', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 12:29:43', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 44980000, b'0', 'cod'),
	(88, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 12:30:05', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 44490000, b'1', 'online'),
	(89, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 12:32:33', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 92470000, b'1', 'online'),
	(90, 'defr', 'sdfsd', 'Phạm Anh Khoa', '2025-12-09 12:35:48', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 30990000, b'0', 'cod'),
	(91, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 12:36:12', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 26990000, b'1', 'online'),
	(92, 'SDFSD', 'SDFSDF', 'Phạm Anh Khoa', '2025-12-09 12:36:55', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 61480000, b'0', 'cod'),
	(93, 'SDFSD', 'SDFD', 'Phạm Anh Khoa', '2025-12-09 12:37:26', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 83470000, b'1', 'online'),
	(94, 'sdfsdf', 'sdfsd', 'Phạm Anh Khoa', '2025-12-09 16:17:37', NULL, NULL, '0901234567', 'Chờ thanh toán', 59, NULL, 27990000, b'0', 'online'),
	(95, 'fdg', 'dfgdfg', 'Phạm Anh Khoa', '2025-12-09 16:18:18', NULL, NULL, '0901234567', 'Chờ thanh toán', 59, NULL, 18990000, b'0', 'online'),
	(96, '', '', '', '2025-12-09 16:21:39', NULL, NULL, '', 'Chờ thanh toán', 59, NULL, 27990000, b'0', 'online'),
	(97, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 16:28:47', NULL, NULL, '0901234567', 'Chờ thanh toán', 59, NULL, 16990000, b'0', 'online'),
	(98, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 16:35:56', NULL, NULL, '0901234567', 'Chờ thanh toán', 59, NULL, 27990000, b'0', 'online'),
	(99, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 16:36:19', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 16990000, b'1', 'online'),
	(100, 'sdfsdf', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 16:42:35', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 24990000, b'1', 'online'),
	(101, 'df', 'sdf', 'Nguyễn Văn A', '2025-12-09 16:44:52', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 27990000, b'0', 'cod'),
	(102, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 16:45:11', NULL, NULL, 'sdf', 'Đang chờ giao', 59, NULL, 92470000, b'0', 'cod'),
	(103, 'sdfsdsdfsd', 'sdfsdfs', 'Phạm Anh Khoa', '2025-12-09 16:52:32', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 22990000, b'1', 'online'),
	(104, 'sdf', 'sdf', 'Phạm Anh Khoa', '2025-12-09 16:55:31', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 24990000, b'1', 'online'),
	(105, 'dfgfsd', 'sdfsdf', 'Phạm Anh Khoa', '2025-12-09 16:59:16', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 22990000, b'1', 'online'),
	(106, 'gfhfg', 'hfghgfhh', 'Phạm Anh Khoa', '2025-12-09 17:02:02', NULL, NULL, '0901234567', 'Đang chờ giao', 59, NULL, 21990000, b'1', 'online'),
	(107, 'sdfdsf', 'sdfsdfds<br> Ghi chú admin:\nsdfsdf', 'Phạm Anh Khoa', '2025-12-09 17:06:09', '2025-12-09 17:07:30', '2025-12-09 17:14:45', '0901234567', 'Hoàn thành', 59, 3, 46980000, b'1', 'online');
...
-- Dumping data for table iphone_shop.gio_hang: ~6 rows (approximately)
...
-- Dumping data for table iphone_shop.hang_san_xuat_seq: ~0 rows (approximately)
...
-- Dumping data for table iphone_shop.lien_he: ~5 rows (approximately)
INSERT INTO `lien_he` (`id`, `email_lien_he`, `ngay_lien_he`, `ngay_tra_loi`, `noi_dung_lien_he`, `noi_dung_tra_loi`, `trang_thai`, `ma_nguoi_tra_loi`, `ho_ten`, `so_dien_thoai`, `tieu_de`) VALUES
	...
	(5, 'phamanhkhoa1609@gmail.com', '2025-12-09 17:58:08', NULL, 'sdfsdfsdfdsfdsfsf', NULL, 'Chưa trả lời', NULL, 'Phạm Anh Khoa', '0901234567', 'Liên hệ từ khách hàng');
...
-- Dumping data for table iphone_shop.nguoidung_vaitro: ~13 rows (approximately)
...
INSERT INTO `nguoi_dung` (`id`, `dia_chi`, `email`, `ho_ten`, `password`, `so_dien_thoai`) VALUES
	...
	(60, '112/2', 'phamanhkhoa16092@gmail.com', 'Phạm Anh Khoa2', '$2a$10$zt5IzsBzNdI7OFVazjOPheInNaFj6pK13elpN4BeP3SD6V9yKKxBq', '0901234567');
...
INSERT INTO `san_pham` (`id`, `chip`, `don_gia`, `don_vi_ban`, `don_vi_kho`, `camera`, `he_dieu_hanh`, `man_hinh`, `dung_luong`, `ten_san_pham`, `mau_sac`, `thong_tin_bao_hanh`, `thong_tin_chung`, `ma_danh_muc`, `ma_hang_sx`, `hinh_anh_url`) VALUES
	...
	(17, 'Apple A16 Bionic', 27990000, 1, 29, 'Camera chính 48MP, Camera góc siêu rộng 12MP, Camera tele 12MP, Camera selfie 12MP', 'iOS 17', '6.1 inch Super Retina XDR OLED, 2556 x 1179 pixels, 120Hz', '512GB', 'iPhone 14 Pro 512GB', 'Bạc', '12 tháng chính hãng Apple', 'iPhone chính hãng Apple, 512GB dung lượng, Bạc, Apple A16 Bionic', 1, 2, 'https://tranphumobile.com/wp-content/uploads/2024/11/iphone-14-pro-vs-iphone-14-pro-max-128gb-256gb-512gb-1tb-mau-trang-600x600.jpg'),
	...
	(19, 'Apple A15 Bionic', 18990000, 1, 49, 'Camera chính 12MP, Camera góc siêu rộng 12MP, Camera selfie 12MP', 'iOS 17', '6.1 inch Liquid Retina HD, 1792 x 828 pixels, 60Hz', '256GB', 'iPhone 14 256GB', 'Tím', '12 tháng chính hãng Apple', 'iPhone chính hãng Apple, 256GB dung lượng, Tím, Apple A15 Bionic', 1, 2, 'https://tranphumobile.com/wp-content/uploads/2024/11/iphone-14-thuong-vs-iphone-14-plus-128gb-256gb-512gb-mau-tim-600x600.jpg'),
...
-- Dumping structure for table iphone_shop.tin_nhan
CREATE TABLE IF NOT EXISTS `tin_nhan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `da_doc` bit(1) NOT NULL,
  `loai_tin_nhan` varchar(255) DEFAULT NULL,
  `noi_dung` varchar(255) DEFAULT NULL,
  `thoi_gian_gui` datetime(6) DEFAULT NULL,
  `cuoc_tro_chuyen_id` bigint(20) NOT NULL,
  `nguoi_gui_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK930sr0e3l8r3c3efagt4yj909` (`cuoc_tro_chuyen_id`),
  KEY `FKfj8y0xh2iicon5lm2swyc2r2j` (`nguoi_gui_id`),
  CONSTRAINT `FK930sr0e3l8r3c3efagt4yj909` FOREIGN KEY (`cuoc_tro_chuyen_id`) REFERENCES `cuoc_tro_chuyen` (`id`),
...
-- Dumping data for table iphone_shop.tin_nhan: ~22 rows (approximately)
INSERT INTO `tin_nhan` (`id`, `da_doc`, `loai_tin_nhan`, `noi_dung`, `thoi_gian_gui`, `cuoc_tro_chuyen_id`, `nguoi_gui_id`) VALUES
	(12, b'1', 'text', 'dfgdfgf', '2025-12-09 19:15:34.773000', 3, 59),
	(13, b'1', 'text', 'hi', '2025-12-09 19:15:46.881000', 3, 55),
	(14, b'1', 'text', '3', '2025-12-09 19:22:08.261000', 3, 55),
	(15, b'1', 'text', 'sdfsdf', '2025-12-09 19:22:27.376000', 3, 59),
	(16, b'1', 'text', 'dsfsd', '2025-12-09 19:22:37.582000', 3, 55),
	(17, b'1', 'text', 'seresr', '2025-12-09 19:30:56.040000', 3, 59),
	(18, b'1', 'text', 'sdfsdfd', '2025-12-09 19:31:12.615000', 3, 55),
	(19, b'1', 'text', 'test 4', '2025-12-09 19:31:34.924000', 3, 59),
	(20, b'1', 'text', 'rrrrr', '2025-12-09 19:31:57.270000', 3, 55),
	(21, b'1', 'text', 'sdfsd', '2025-12-09 19:32:02.111000', 3, 55),
	(22, b'1', 'text', 'sdfdsfdsf', '2025-12-09 19:32:14.870000', 3, 55),
	(23, b'1', 'text', 'sdfsdf', '2025-12-09 19:32:16.301000', 3, 55),
	(24, b'1', 'text', 'sdfdsf', '2025-12-09 19:33:30.671000', 3, 59),
	(25, b'1', 'text', 'hhahaa', '2025-12-09 19:36:18.264000', 3, 55),
	(26, b'1', 'text', 'sdfsdf', '2025-12-09 19:42:05.914000', 4, 60),
	(27, b'1', 'text', 'haha', '2025-12-09 19:42:25.603000', 4, 55),
	(28, b'1', 'text', 'haaa', '2025-12-09 19:42:32.393000', 4, 60),
	(29, b'1', 'text', 'sdfsdf', '2025-12-09 19:42:48.337000', 4, 55),
	(30, b'1', 'text', '3', '2025-12-09 19:45:00.605000', 4, 60),
	(31, b'1', 'text', 'sdfdsf', '2025-12-09 19:45:21.790000', 3, 59),
	(32, b'1', 'text', '2', '2025-12-09 19:45:52.440000', 3, 59),
	(33, b'1', 'text', '2', '2025-12-09 19:45:58.165000', 3, 55);
